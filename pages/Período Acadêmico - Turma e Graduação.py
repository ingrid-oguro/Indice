...
base = pd.read_excel('Indice/pages/periodo_graduação.xlsx')
base_turma = pd.read_excel('Indice/pages/periodo_turma.xlsx')
periodo = pd.read_excel('Indice/pages/periodo.xlsx')
#
